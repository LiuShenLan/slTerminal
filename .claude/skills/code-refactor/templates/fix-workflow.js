...
// =====================================================================
// 用法: 读取此文件，替换 __PLACEHOLDER__，落盘 workflows/fix-loop.js，
//       语法预检后由主 agent 调用：
...
//   verifyFile: string — 断言清单文件路径（必填，如 workflows/verify/stage-01.md）
...
if (typeof args.verifyFile !== 'string' || args.verifyFile.length === 0) {
  throw new Error('fix-loop 需要 args.verifyFile（断言清单文件路径，如 workflows/verify/stage-01.md）')
}
