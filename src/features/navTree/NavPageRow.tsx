...
// 页面图标：icons.tsx 无文档图标导出（IC-01 单点）——等宽占位（照 SidebarTree 先例；
// mockup 为文档图标，待 IC-01 补充后替换，NAV-06 执行者可跟进）。
...
import { FOCUS_BORDER, INPUT_BG, SIDEBAR_COLORS, SIDEBAR_FG } from "../../theme";
...
export const NavPageRow: React.FC<NavPageRowProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* 页面图标槽位：icons.tsx 无文档图标导出（IC-01 单点）——等宽占位对齐项目行图标 */}
