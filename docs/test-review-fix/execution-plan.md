...
|-------|------|------------|---------------|-------------|
| 01 | ☑ | 6 项 + GATE 全过 | 0 | b53dfc6 |
| 02 | ☑ | 6 项 + GATE 全过 | 0 | 6d308ed |
| 03 | ☑ | 7 项 + GATE 全过 | 0 | 9b027ca |
| 04 | ☑ | 12 项 + GATE 全过 | 0 | 56e0539 |
| 05 | ☑ | 4 项 + GATE 全过（fix-loop 1 轮修 tsc） | 1 | 721d047 |
| 06 | ☑ | 2 项 + 行为不变核查 + GATE 全过 | 0 | d80677c |
| 07 | ☑ | 5 项 + GATE 全过（editor flaky 复跑通过，全量 9/9） | 0 | ac94374 |
| 08 | ☑ | 8 项 + GATE 全过（fix-loop 1 轮修 tracing-test 捕获） | 1 | e55b02e |
| 09 | ☑ | 4 项 + yaml 合法性 + GATE 全过 | 0 | c6f9876 |
| 10 | ☑ | 10 项全过；L4 editor dirty→clean 环境级故障登记豁免（Windows notify，实证与代码无关） | 0 | 待提交 |
