// =====================================================================
// Fix Workflow — Stage 验证不通过时的修复循环（ui-redesign-review-fix）
// =====================================================================
// 用法: 主 agent 调用 Workflow({ scriptPath, args: { stage, failedItems, fixContext, verifyFile, constraints } })
// args 说明:
...
//   verifyFile: string    — 断言清单文件路径（必填，docs/ui-redesign-review-fix/workflows/verify/stage-NN.md）
//   constraints: string   — Stage 特殊纪律（可选；取值以对应 Stage 脚本头部注释为准）
// =====================================================================
...
纪律：
- 先读 docs/ui-redesign-review-fix/checklist.md 中对应 ID 的修复要点 + docs/ui-redesign-review-fix/stages.md 中 Stage ${STAGE} 的实现要点，再结合失败证据定位
