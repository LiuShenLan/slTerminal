...
| 05 | ✅ 已完成 | 0f421ea | 一次通过，无 fix-loop |
| 06 | ✅ 已完成 | db1a393 | fix-loop 1 轮（jsdom 颜色归一化断言 + gitshow 用例漏设 mock） |
| 07 | ✅ 已完成 | 77f3153 | fix-loop 1 轮（4 处文档「已删」口径 + 1 观察项注释） |
| 08 | ✅ 已完成 | f4de871 | fix-loop 3 轮（TE-01 断言方向→TE-04 全文件 id→TE-03 注释术语）；e2e 9/9 |
| 09 | ✅ 已完成 | c1dffc5 | 一次通过，无 fix-loop |
