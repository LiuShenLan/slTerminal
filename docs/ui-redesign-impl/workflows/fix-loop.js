// =====================================================================
// fix-loop — Stage 验证不通过时的修复循环（ui-redesign-impl）
// 调用: Workflow({ scriptPath, args: { stage, failedItems, fixContext, verifyFile, constraints } })
//   stage: number         — 所属 Stage 编号
//   failedItems: string[] — 未通过项 ID（必填非空，来自 Stage verify）
//   fixContext: string    — verify agent 的 details 证据原文
//   verifyFile: string    — 断言清单路径（docs/ui-redesign-impl/workflows/verify/stage-NN.md，必填）
...
纪律：
- 先读 docs/ui-redesign-impl/checklist.md 中对应 ID 的修复要点 + docs/ui-redesign-impl/stages.md 中 Stage ${STAGE} 的实现要点，再结合失败证据定位
