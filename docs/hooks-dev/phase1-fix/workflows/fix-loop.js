// =====================================================================
// Fix Workflow（phase1-fix）— Stage 验证不通过时的修复循环
// =====================================================================
// 调用：
//   Workflow({ scriptPath: "docs/hooks-dev/phase1-fix/workflows/fix-loop.js",
//     args: { stage, failedItems, fixContext, verifyFile, constraints } })
// constraints 应传值（见 stage-01-docs.js 头注释）：
...
纪律：
- 先读 docs/hooks-dev/phase1-fix/checklist.md 中对应 ID 的修复要点 + docs/hooks-dev/phase1-fix/stages.md 中 Stage ${STAGE} 的实现要点，再结合失败证据定位
