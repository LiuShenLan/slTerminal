// =====================================================================
// Phase 2-fix 修复循环 — Stage 验证不通过时由主 agent 循环调用（最多 3 轮）
// =====================================================================
...
//   verifyFile: string    — 断言清单文件路径（必填，仓根相对全路径，
//                           如 docs/hooks-dev/phase2-fix/workflows/verify/stage-01.md）
//   constraints: string   — Stage 特殊纪律（可选；值见对应 Stage 脚本头注释单一真值源，
//                           禁止凭印象另写）
// =====================================================================
...
纪律：
- 先读 docs/hooks-dev/phase2-fix/checklist.md 中对应 ID 的修复要点 + docs/hooks-dev/phase2-fix/stages.md 中 Stage ${STAGE} 的实现要点，再结合失败证据定位
