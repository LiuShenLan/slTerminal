// =====================================================================
// Fix Workflow — Phase 3 修复循环
// =====================================================================
// 用法: 由主 agent 调用，args: { stage, failedItems, fixContext, verifyFile, constraints }
// =====================================================================

export const meta = {
  name: 'fix-loop',
  description: '修复循环: 针对 Stage 验证失败项修复并重验',
  phases: [
    { title: '修复问题' },
    { title: '全量测试' },
    { title: '逐项验证' },
...
纪律：
- 先读 docs/hooks-dev/phase3/checklist.md 中对应 ID 的修复要点 + docs/hooks-dev/phase3/stages.md 中 Stage ${STAGE} 的实现要点，再结合失败证据定位
